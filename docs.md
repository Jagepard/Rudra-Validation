...
> Класс валидации данных Class Validation
...
| public | <strong>access(</strong><em>mixed</em> <strong>$data</strong>)</strong> : <em>bool</em><br /><em>Проверяет все результаты собранные в массив</em> |
...
| protected | <strong>captchaSecret()</strong> : <em>string</em> |
| protected | <strong>data()</strong> : <em>string</em> |
| protected | <strong>isResult()</strong> : <em>bool</em> |
| protected | <strong>message()</strong> : <em>string</em> |
| protected | <strong>setData(</strong><em>mixed</em> <strong>$data</strong>)</strong> : <em>void</em> |
| protected | <strong>setMessage(</strong><em>mixed</em> <strong>$message</strong>)</strong> : <em>void</em> |
| protected | <strong>setResult(</strong><em>bool/\boolean</em> <strong>$result</strong>)</strong> : <em>void</em> |
